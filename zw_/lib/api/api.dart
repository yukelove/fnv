class Api {
  ...
  static const  USER_UPDATE = BASE_URL + 'ZWUserUpdate/UserUpdate'; //用户更新

  static const String GET_VALIDATE_CODE = BASE_URL + 'ZWUserRegister/UserValidateCode'; //获取校验码

  static const String RETRIEVE_PASSWORD = BASE_URL + 'ZWUserRegister/UserRetrivePwd'; //找回密码接口

  static const String MODIFY_PASSWORD = BASE_URL + 'ZWUserUpdate/UserUpdatePassword';//修改密码
  ...
  static const String SET_DEVICES_SWITCH_CONFIG = BASE_URL+'ZWDeviceSwitch/SetDevicesSwitchConfig';//节能运行设置

  static const String QUERY_DEVICES_SWITCH_CONFIG = BASE_URL+'ZWDeviceSwitch/QueryDevicesSwitchConfig'; //查询节能设置
}
