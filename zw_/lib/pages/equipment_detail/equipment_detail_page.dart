...
class _EquipmentDetailState extends State<EquipmentDetail> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      lazy: false,
      create: (_) {
        return EquipmentDetailCubit(EquipmentDetailState(serialnumber: widget.serialnumber,info: {}));
      },
      child: BlocBuilder<EquipmentDetailCubit,EquipmentDetailState>(builder: (ctx,state){
        //
        return Scaffold(
                          ...
                          children: [
                            Text.rich(TextSpan(children: [
                              ...
                              TextSpan(
                                  text: " V",
                                  style:
                                      TextStyle(fontSize: FontRes.font_sp16)),
                            ])),
                            Text.rich(TextSpan(children: [
                              TextSpan(
                                  text: "100",
