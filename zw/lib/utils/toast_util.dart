...
import 'package:zw/utils/ScreenUtil.dart';
...
class Toast {
  ...
  /// 显示位置
  static late ToastPostion _toastPosition;
  ...
  static noHaveNetworkToastCloseCallBack(String text, AlignmentGeometry align) {
    if (isShowToast) {
      return;
    }
    isShowToast = true;
    BotToast.showText(
      ...
      contentPadding: EdgeInsets.fromLTRB(24.0, 11.0, 24.0, 11.0),
      onClose: () {
        isShowToast = false;
      },
      textStyle:
